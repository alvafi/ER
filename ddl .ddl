...
COMMENT ON COLUMN rental_area.street IS
    'Часть адреса, возможного расположения арендованного автомобиля';

COMMENT ON COLUMN rental_area.house_number IS
    'Часть адреса, возможного расположения арендованного автомобиля';
...
ALTER TABLE brand_of_car
    ADD CONSTRAINT brand_car_fk FOREIGN KEY ( car_car_id )
